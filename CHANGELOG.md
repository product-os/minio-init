...
* Switch to pgsty/minio images [Kyle Harding]
* Drop the unused yq package [Kyle Harding]
* Pin ansible-core and drop unused dependencies [Kyle Harding]
* Replace the removed community.general.yaml callback [Kyle Harding]
